 ...
 *Modelo Version
 */
class CocheModelVersion extends JModelAdmin
{
        /**
         ...
         * @since       2.5
         */
        public function getTable($type = 'Version', $prefix = 'CocheTable', $config = array()) 
        {
        ...
        {
                // Get the form.
                $form = $this->loadForm('com_coche.version', 'version',
        ...
        protected function loadFormData() 
        {
                ...
                $data = JFactory::getApplication()->getUserState('com_coche.edit.version.data', array());
                if (empty($data)) 
                {
                        $data = $this->getItem();
                }
