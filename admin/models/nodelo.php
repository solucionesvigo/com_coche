 ...
 *Modelo Nodelo
 */
class CocheModelNodelo extends JModelAdmin
{
        /**
         ...
         * @since       2.5
         */
        public function getTable($type = 'Nodelo', $prefix = 'CocheTable', $config = array()) 
        {
        ...
        {
                // Get the form.
                $form = $this->loadForm('com_coche.nodelo', 'nodelo',
        ...
        protected function loadFormData() 
        {
                ...
                $data = JFactory::getApplication()->getUserState('com_coche.edit.nodelo.data', array());
                if (empty($data)) 
                {
                        $data = $this->getItem();
                }
