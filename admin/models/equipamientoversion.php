...
/**
 *Modelo Equipamientoversion
 */
class CocheModelEquipamientoversion extends JModelAdmin
{
        /**
         ...
         * @since       2.5
         */
        public function getTable($type = 'Equipamientoversion', $prefix = 'CocheTable', $config = array()) 
        {
        ...
        {
                // Get the form.
                $form = $this->loadForm('com_coche.equipamientoversion', 'equipamientoversion',
        ...
        protected function loadFormData() 
        {
                ...
                $data = JFactory::getApplication()->getUserState('com_coche.edit.equipamientoversion.data', array());
                if (empty($data)) 
                {
                        $data = $this->getItem();
                }
