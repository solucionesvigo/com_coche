...
/**
 *Modelo Equipamientoclase
 */
class CocheModelEquipamientoclase extends JModelAdmin
{
        /**
         ...
         * @since       2.5
         */
        public function getTable($type = 'Equipamientoclase', $prefix = 'CocheTable', $config = array()) 
        {
        ...
        {
                // Get the form.
                $form = $this->loadForm('com_coche.equipamientoclase', 'equipamientoclase',
        ...
        protected function loadFormData() 
        {
                ...
                $data = JFactory::getApplication()->getUserState('com_coche.edit.equipamientoclase.data', array());
                if (empty($data)) 
                {
                        $data = $this->getItem();
                }
